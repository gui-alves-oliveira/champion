...
const buttonVariants = tv({
  variants: {
    intent: {
      primary:
        "mt-2 text-sm bg-green-500 disabled:bg-green-500/50 h-10 px-4 w-full rounded",
      secondary:
        "mt-2 text-sm bg-neutral-800 disabled:bg-neutral-800/50 h-10 px-4 w-full rounded",
      transparent: "",
      input:
